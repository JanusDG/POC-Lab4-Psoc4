...
module ADC_SAR_SEQ_P4_v2_50_6 (
	...
	cy_clock_v1_0
		#(.id("ed378805-286f-4a91-9513-1883357df523/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
	...
	wire [0:0] tmpOE__Pin_A0_net;
	wire [0:0] tmpFB_0__Pin_A0_net;
	wire [0:0] tmpIO_0__Pin_A0_net;
	wire [0:0] tmpINTERRUPT_0__Pin_A0_net;
	electrical [0:0] tmpSIOVREF__Pin_A0_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_A0
		 (.oe(tmpOE__Pin_A0_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_A0_net[0:0]}),
		  .analog({Net_2508}),
		  .io({tmpIO_0__Pin_A0_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_A0_net),
		  .interrupt({tmpINTERRUPT_0__Pin_A0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_A0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
