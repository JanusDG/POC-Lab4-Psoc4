...
static CYBLE_AIOSS_CHAR_T aiossCharIdx1[0x04u] = {
    ...
    {
        0x0044u, /* Handle of the Analog ADC characteristic */ 
        
            /* Array of Descriptors handles */
            {
                0x0045u, /* Handle of the Client Characteristic Configuration descriptor */ 
                0x0046u, /* Handle of the Characteristic Presentation Format descriptor */ 
                0x0047u, /* Handle of the Characteristic User Description descriptor */ 
                CYBLE_GATT_INVALID_ATTR_HANDLE_VALUE, /* Handle of the Characteristic Extended Properties descriptor */ 
                CYBLE_GATT_INVALID_ATTR_HANDLE_VALUE, /* Handle of the Value Trigger Setting descriptor */ 
                CYBLE_GATT_INVALID_ATTR_HANDLE_VALUE, /* Handle of the Time Trigger Setting descriptor */ 
                0x0048u, /* Handle of the Valid Range descriptor */ 
            }, 
    },
    {
        0x004Du, /* Handle of the Analog DISPLAY characteristic */ 
        
            /* Array of Descriptors handles */
            {
                0x004Eu, /* Handle of the Client Characteristic Configuration descriptor */ 
                0x004Fu, /* Handle of the Characteristic Presentation Format descriptor */ 
                0x0050u, /* Handle of the Characteristic User Description descriptor */ 
                CYBLE_GATT_INVALID_ATTR_HANDLE_VALUE, /* Handle of the Characteristic Extended Properties descriptor */ 
                CYBLE_GATT_INVALID_ATTR_HANDLE_VALUE, /* Handle of the Value Trigger Setting descriptor */ 
                CYBLE_GATT_INVALID_ATTR_HANDLE_VALUE, /* Handle of the Time Trigger Setting descriptor */ 
                0x0051u, /* Handle of the Valid Range descriptor */ 
            }, 
    },
};
...
static CYBLE_AIOSS_CHAR_T aiossCharIdx2[0x01u] = {
    {
        0x004Au, /* Handle of the Aggregate characteristic */ 
